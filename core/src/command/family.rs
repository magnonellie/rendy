    ...
    C: Copy + Debug,
{
    ...
    pub(crate) unsafe fn from_device(fp: Arc<ash::vk::DeviceFnV1_0>, device: ash::vk::Device, id: FamilyId<C>, count: u32) -> Self {
        Family {
            id,
            queues: (0 .. count).map(|queue_index| {
    ...
    pub(crate) unsafe fn from_raw(fp: Arc<ash::vk::DeviceFnV1_0>, device: ash::vk::Device, id: FamilyId<C>, queues: Vec<Queue<C>>) -> Self {
        Family {
            id,
            queues,
            fp,
