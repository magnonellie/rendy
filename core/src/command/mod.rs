//! This module is dedicated to wrap unsafe command queues/pools/buffers
//! in order to provide more robust and less error-prone API.
//! 
//! # Queues
//! 
//! Command queues are belong to queue families.
